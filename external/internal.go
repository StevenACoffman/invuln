...
// Keep in sync with vulndb/external/database/generate.go.
const (
	// GoStdModulePath is the external Go module path string used
	// when listing vulnerabilities in standard library.
	GoStdModulePath = "stdlib"

	// GoCmdModulePath is the external Go module path string used
