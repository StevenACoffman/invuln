...
func TestFrame(t *testing.T) {
	for _, test := range []struct {
	...
	}{
		{
			...
			frame: &govulncheck.Frame{
				Package:  "github.com/StevenACoffman/invuln/external/vulncheck",
				Function: "Foo",
				Position: &govulncheck.Position{Filename: "some/path/file.go", Line: 12},
			},
			wantFunc: "github.com/StevenACoffman/invuln/external/vulncheck.Foo",
		...
		},
		{
			...
			wantFunc: "github.com/StevenACoffman/invuln/external/vulncheck.Bar.Foo",
		},
		{
