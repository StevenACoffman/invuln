...
// SymbolInfo is derived from cmd/external/objfile/elf.go:symbols, symbolData.
...
// PCLNTab is derived from cmd/external/objfile/elf.go:pcln.
...
// SymbolInfo is derived from cmd/external/objfile/pe.go:findPESymbol, loadPETable.
...
// PCLNTab is derived from cmd/external/objfile/pe.go:pcln.
...
// SymbolInfo is derived from cmd/external/objfile/macho.go:symbols.
...
// SymbolInfo is derived from cmd/external/objfile/macho.go:pcln.
