...
import (
	...
	"github.com/StevenACoffman/invuln/external/traces"
)
	...
	r := Run{
		Tool: Tool{
			Driver: Driver{
				...
				InformationURI: "https://pkg.go.dev/github.com/StevenACoffman/invuln/cmd/govulncheck",
				Properties:     *cfg,
				Rules:          rules(h),
			},
		},
...
func fileURIInfo(filename, top, module, version string) (string, string) {
	...
	if module == external.GoStdModulePath {
